...
public class InfoExposureConfigTable extends JTable {
    private final InfoExposureConfigTableModel tableModel;

    public InfoExposureConfigTable(TableModel tableModel) {
        super(tableModel);
        this.tableModel = (InfoExposureConfigTableModel) tableModel;
